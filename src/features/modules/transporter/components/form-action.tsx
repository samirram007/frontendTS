...
import { Route as TransporterRoute } from '@/routes/_authenticated/masters/party/_layout/transporter/_layout'
...
export function FormAction({ currentRow }: Props) {
    ...
    //  const transporterStatusOptions: ActiveInactiveStatus[] = ['active', 'inactive'];
    ...
    const onSubmit = (values: TransporterForm) => {
        ...
        saveTransporter(
            ...
            {
                onSuccess: () => {
                    navigate({ to: TransporterRoute.to, })
                },
            }
        )
