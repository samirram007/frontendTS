    ...
    return(
        <Dialog>
            <DialogTrigger disabled={patientSearch == null ? true : false}>
                {button ? button : <span className="text-primary underline underline-offset-1">Edit new patient</span>}
            </DialogTrigger>
                        ...
                        {({})=>(
                            <Form>
                                ...
                                <div className="grid justify-center gap-3 mt-4 border-t-2 border-gray-200 pt-4">
                                    <Button type="submit" variant={'default'} size={'sm'} className="!bg-primary !text-white !px-12 !py-5 text-app-base-lg">Save</Button>
                                </div>
                            </Form>
                        )}
                    </Formik>
