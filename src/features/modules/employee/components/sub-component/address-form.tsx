        ...
        <div className="grid grid-cols-1 grid-rows-[auto_auto_auto] gap-4 border rounded-lg p-2">
            ...
            <div className="grid grid-rows-3 gap-4">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <FormInputField type="text" gapClass={gapClass2} form={form} name="address.postOffice" label="PO" />
                    <FormInputField type="text" gapClass={gapClass2} form={form} name="address.district" label="District" />

                </div>
                <div className="grid grid-cols-2 gap-6">


                    <FormInputField type="text" gapClass={gapClass2} form={form} name="address.city" label="City" />
                    <FormInputField type="text" gapClass={gapClass2} form={form} name="address.postalCode" label="Postal Code" />
                </div>
                <div className="grid grid-cols-2 gap-6">

                    <StateDropdown form={form} gapClass={gapClass2} />
                    <CountryDropdown form={form} gapClass={gapClass2} />
                </div>
