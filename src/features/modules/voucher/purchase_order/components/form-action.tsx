...
const FormAction = ({ currentRow }: PurchaseOrderProps) => {
    return (
        <>
...
const VoucherHeader = () => {
    const methods = useFormContext<PurchaseOrderForm>()
    const { watch } = useFormContext<PurchaseOrderForm>()
            ...
            <div className="grid grid-cols-[350px_1fr_200px] border-amber-300 border-0">
                ...
                <div className="space-y-0">
                    <div className="grid grid-cols-[120px_200px] gap-2">
                        <div className="bg-red-400 text-gray-100 px-2">Purchase Order</div>
