...
const ContentSwitcher = ({ data }: { data: OrderbookSchema }) => {
  if (
...
const FreightPrintDialog = (printData: OrderbookSchema) => {
  return (
    <>
...
const DeliveryNotePrintDialog = (printData: OrderbookSchema) => {
  return (
    <>
      <div className="x-header">
        <div className="text-center font-semibold underline underline-offset-4 decoration-2 decoration-blue-700">
