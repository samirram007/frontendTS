...
const PosHeader = ({ mainForm: form }: PosHeaderProps) => {
  // const form = useFormContext<TransferVoucherForm>()
  //const form = mainForm;
    ...
    <div className="grid grid-rows-1   ">
      <div className="grid grid-cols-[350px_1fr_100px]   border-0">
        <div className="space-y-0">
          <div className="grid grid-cols-[140px_200px] gap-2 ">
      ...
      <div className="grid grid-cols-2 gap-2 pb-2">
        <div className="sm:hidden grid grid-cols-2 gap-2 items-center">
          <pre>{JSON.stringify(form.getValues('party'), null, 2)}</pre>
...
type DateBoxProps = {
  form: UseFormReturn<TransferVoucherForm>
  name: keyof TransferVoucherForm
  tabIndex?: number
}
