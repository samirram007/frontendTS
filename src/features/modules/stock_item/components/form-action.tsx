...
import { bomItemByStockItemQueryOptions } from '../data/bomQueryOptions'
import { PosProvider } from '../../voucher/contexts/pos-context'
...
const BatchManagement = ({ form }: FormProps) => {
  ...
  const hasBom = form.watch('hasBom')
  ...
  const { data: bom } = useQuery({
    ...bomItemByStockItemQueryOptions(stockItemId),
    enabled: !!stockItemId, // runs only if id exists and is valid
  })
