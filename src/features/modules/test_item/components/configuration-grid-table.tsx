...
interface DataTableProps {
  columns: ColumnDef<TestItemReportTemplateResponseSchema>[]
  data: TestItemReportTemplateResponseSchema[]
}

export function ConfigurationGridTable({ columns, data }: DataTableProps) {
