...
import { Route as DistributorRoute } from '@/routes/_authenticated/masters/party/_layout/distributor/_layout'
...
export function FormAction({ currentRow }: Props) {
    ...
    //  const distributorStatusOptions: ActiveInactiveStatus[] = ['active', 'inactive'];
