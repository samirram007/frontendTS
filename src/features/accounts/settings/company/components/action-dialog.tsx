...
import type { Company, CompanyForm } from '@/features/accounts/settings/company/data/schema'
...
import { formSchema } from '../../company/data/schema'
import { storeCompanyService, updateCompanyService } from '../data/api'
import AccountEffectDropdown from './company_type-dropdown'
