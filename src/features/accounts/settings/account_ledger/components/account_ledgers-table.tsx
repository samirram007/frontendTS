...
import type { AccountLedger } from '@/features/accounts/settings/account_ledger/data/schema'
import {
  flexRender,
  getCoreRowModel,
  getFacetedRowModel,
...
interface DataTableProps {
  columns: ColumnDef<AccountLedger>[]
  data: AccountLedger[]
}

export function AccountLedgersTable({ columns, data }: DataTableProps) {
