  ...
  if (!userFiscalYear) {
    return (
      <div className="flex flex-row gap-6 items-center justify-center text-center text-red-600 font-semibold">
        <div>
          It looks like no Fiscal Year is assigned. Please set one or contact
          support.
        </div>
        <Button
          className=" text-blue-700 border-blue-600 border-2"
          variant="outline"
          size="sm"
          asChild
        >
      ...
      {headerVisible && (
        <>
          <div className="space-y-0.5">
            ...
            <p className="text-muted-foreground">Manage your transaction.</p>
          </div>
