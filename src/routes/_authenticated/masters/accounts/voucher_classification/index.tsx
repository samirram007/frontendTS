import VoucherClassification from '@/features/accounts/settings/voucher_classification'
import { voucherClassificationQueryOptions } from '@/features/accounts/settings/voucher_classification/data/queryOptions'
