...
const TestItemConfigurations = React.lazy(() =>
    import('@/features/modules/test_item/configuration')
)
...
export const Route = createFileRoute(
  '/_authenticated/masters/inventory/_layout/test_item/_layout/$id/configuration',
)({
  params:{
